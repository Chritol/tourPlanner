...
public enum Event {
  ...
  TOUR_CHANGED, 
  ACTIVE_TOUR_CHANGED,
    SELECT_NEW_ACTIVE_TOUR_ACTION, TOUR_CHANGED, ACTIVE_TOUR_CHANGED, FILE_BUTTON_ACTION, OPEN_PICTURES_DIRECTORY_ACTION, OPEN_FILE_DIRECTORY_ACTION, OPEN_HELP_ACTION,
