...
public enum Event {
    ...
    // Bsp. Events
    CREATE_WORD,
    IMAGE_SAVED, NEW_TOUR_ACTION, REMOVE_TOUR_ACTION, OPEN_TOUR_ACTION, EDIT_TOUR_ACTION, EXIT_FORM_TOUR_ACTION, OPEN_MAP_ACTION, OPEN_MISC_ACTION, NEW_LOG_ACTION, REMOVE_LOG_ACTION, DELETE_WORD
}
