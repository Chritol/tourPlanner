package at.technikum.tolanzeilinger.tourplanner.presentation.viewModel.TourListComponents;
...
public class TourListViewModel implements ViewModel {
    ...
    private final ListProperty<String> tourNames = new SimpleListProperty<String>();
