...
public class PDFcViewModel implements ViewModel {
    ...
    private final BooleanProperty pdfExportButtonDisabled = new SimpleBooleanProperty(false);
    private final BooleanProperty excelExportButtonDisabled = new SimpleBooleanProperty(false);
